...
BEGIN {
	$PPI::Structure::Block::VERSION = '0.829';
...
BEGIN {
	$PPI::Structure::Subscript::VERSION = '0.829';
...
# The else block
BEGIN {
	$PPI::Structure::Constructor::VERSION = '0.829';
...
BEGIN {
	$PPI::Structure::Condition::VERSION = '0.829';
...
BEGIN {
	$PPI::Structure::List::VERSION = '0.829';
...
BEGIN {
	$PPI::Structure::ForLoop::VERSION = '0.829';
...
BEGIN {
	$PPI::Structure::Unknown::VERSION = '0.829';
